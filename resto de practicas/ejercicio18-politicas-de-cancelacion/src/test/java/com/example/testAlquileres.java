...
import com.example.PoliticaCancelacion.Estricta;
import com.example.PoliticaCancelacion.Flexible;
import com.example.PoliticaCancelacion.Moderada;
...
public class testAlquileres {
    ...
    public void testCrearCancelarReserva() {
        ...
        assertTrue(propiedad1.cancelarReserva(r1));
    ...
    public void testCalcularCostos() {
        ...
        // Ver Reembolso
        Usuario u2 = new Usuario("German", 40323430);
        LocalDate desde2 = LocalDate.of(2024, 12, 1);
        LocalDate hasta2 = LocalDate.of(2024, 12, 10);
        DateLapse tiempo2 = new DateLapse(desde2, hasta2);
        Reserva r2 = new Reserva(u2, propiedad2, tiempo2);
        PoliticaCancelacion p;
        // Reembolso flexible
        p = new Flexible();
        r2.setPoliticaCancelacion(p);
        assertEquals(r2.calcularReembolso(), 1080);
        // Reembolso moderado
        p = new Moderada();
        r2.setPoliticaCancelacion(p);
        assertEquals(r2.calcularReembolso(), 1080);
        ...
        p = new Estricta();
        r2.setPoliticaCancelacion(p);
        assertEquals(r2.calcularReembolso(), 0);
    }
}
